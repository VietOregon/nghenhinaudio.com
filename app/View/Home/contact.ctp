<div id="contact">
	<div class="container content">
		<div class="message">
			<p><?php echo __('CONTACT_TEXT_1')?></p>
			<br>
		</div>
		<!-- Start Form Contact -->
				<?php
		...
		<fieldset>
			...
			<section class="field">
				<label class="label col-sm-2"><?php echo __('CONTACT_TEXT_10')?></label>
				<label class="input col-sm-10">
					<i class="icon-prepend fa fa-tag"></i>
					<?php
					echo $this->Form->input ( 'division', array ('name' => 'division','id' => 'division','label' => false,'div' => false,'type' => 'text'
					) );
					?>
				</label>
			</section>
			<section class="field">
				<label class="label col-sm-2"><?php echo __('CONTACT_TEXT_12')?></label>
				<label class="input col-sm-10">
					<i class="icon-prepend fa fa-tag"></i>
					<?php
					echo $this->Form->input ( 'position', array ('name' => 'position','id' => 'position','label' => false,'div' => false,'type' => 'text'
					) );
					?>
				</label>
			</section>
