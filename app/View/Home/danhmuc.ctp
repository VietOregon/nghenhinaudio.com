									...
									<ol class="breadcrumb">
										...
										<li>
											<a href="javascript:void(0);" class="itemcrumb active">
												<span itemprop="title"><?php echo isset($category["Category"]['category_name']) ? $category["Category"]['category_name'] : 'Sản phẩm'; ?></span>
											</a>
										</li>
									</ol>
								</div>
...
<div class="container" style="margin-bottom: 20px;">
	<div class="row">
	  	<div class="col-md-9" style="margin-top: 10px;">
			<h2>Sản phẩm <?php echo isset($category["Category"]['category_name']) ? $category["Category"]['category_name'] : ''; ?></h2>
		...
		<div class="col-md-3">
			<h3>Danh mục cùng loại</h3>
			<div class="ModuleContent">
				<div class="panel-group">
					<?php foreach ($relatedCategories as $ralated_category): ?>
						<div class="panel panel-default">
							<div class="panel-heading">
								<h4 class="panel-title">
									<a href="<?php echo $base_url.'danh-muc/'.$ralated_category['Category']['category_slug']; ?>" alt="<?php echo $ralated_category['Category']['category_name']; ?>"><?php echo $ralated_category['Category']['category_name']; ?></a>
								</h4>
							</div>
						</div>
					<?php endforeach; ?>
