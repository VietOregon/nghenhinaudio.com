			...
			<div class="row">
				<div class="col-sm-12 Module Module-144">
					<ol class="breadcrumb">
						...
						<li>
						<a href="<?php echo $base_url.''.$product['SelectOption']['select_name'].'/	'; ?>" alt="<?php echo $product['SelectOption']['display_name']; ?>"><?php echo $product['SelectOption']['display_name']; ?></a>
						</li>
						<li>
...
<div class="container">
	<div class="row">
		...
		<div class="col-sm-3 Module Module-158">
			<h3>Danh mục <?php echo $product['SelectOption']['display_name']; ?></h3>
			<div class="ModuleContent">
                  ...
                  <div class="span12">
                    <div class="carousel slide" id="myCarousel1">
                      <div class="carousel-inner">
                        <?php if (isset($related_products) && count($related_products) >= 4): ?>
                        <?php for ($i=0; $i < count($related_products); $i++) { ?>
                          ...
                          <?php endif; ?>
                            <li class="span3">
                              <div class="thumbnail">
                              	<a href="<?php echo $base_url.'san-pham/'.$related_products[$i]['Product']['product_slug']; ?>" alt="<?php echo $related_products[$i]['Product']['product_name']; ?>">
                              ...
                              <div class="caption alignCenter">
                                ...
                                <h4>
                                  <a href="<?php echo $base_url.'san-pham/'.$related_products[$i]['Product']['product_slug']; ?>" alt="<?php echo $related_products[$i]['Product']['product_name']; ?>"><?php echo $related_products[$i]['Product']['product_name']; ?></a>
                                </h4>
                              </div>
                            </li>
                          <?php if (($i+1)%4 == 0): ?>
