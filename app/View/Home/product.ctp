						                        ...
						                        <?php for ($i=0; $i < count($product_img); $i++) { ?>
						                        	<li id="slide<?php echo $i; ?>">
														<div class="cbp-content">
															<img src="<?php echo $base_url . 'img/products/' . $product_img[$i]["ProductImage"]["image_url"];?>" alt="<?php echo $product_img[$i]['ProductImage']['image_url']; ?>" style="width: 100%; height: 100%" />
														</div>
													</li>
						                        <?php } ?>
						                        <?php endif; ?>
                            ...
                            <li class="span3">
                              <div class="thumbnail">
                              	<a href="<?php echo $base_url.'san-pham/'.$related_products[$i]['Product']['id']; ?>" alt="<?php echo $related_products[$i]['Product']['product_name']; ?>">
                                	<img src="<?php echo $base_url . 'img/products/' . $related_products[$i]["ProductImage"]["image_url"];?>" alt="<?php echo $related_products[$i]['Product']['product_name']; ?>" style="height: 100%" />
                                </a>
                              </div>
