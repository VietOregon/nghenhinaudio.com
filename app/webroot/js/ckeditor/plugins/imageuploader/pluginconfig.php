...
$useruploadfolder = 'http://'.$_SERVER['SERVER_NAME'].Router::url('/app/webroot/img/products/');
$useruploadpath = 'http://'.$_SERVER['SERVER_NAME'].Router::url('/app/webroot/img/products/');
